    ...
    <nav className="bg-white border-gray-200  rounded dark:bg-gray-900">
      <div className="container flex flex-wrap items-center justify-between mx-auto my-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          {
            localStorage.getItem('STTP-user') ? (
              < ul className="flex flex-row p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 
                ...
                <div>
                  <Link to="/dashboard" >
                    <Button className="bg-red-500 hover:bg-red-400 text-white 
                      font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded" label="Time Table" >
                    </Button>
                  </Link>
                  <Link to="/courseselection" >
                    <Button className="bg-red-500 hover:bg-red-400 text-white 
                      font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded" label="Course Selection" >
                    </Button>
                  </Link>
                  <Link to="/" >
                    <Button className="bg-red-500 hover:bg-red-400 text-white 
                      font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded" label="Log out" onClick={logOut}>
                    </Button>
                  </Link>
                </div>
              </ul>) : null
